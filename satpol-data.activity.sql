...
INSERT INTO  activity.mst_business_partner (bp_uuid, bp_name, corporate_code) VALUES
('800c84c5-9877-497f-b72f-27046a9190cb', 'Alfa One Kenten', 'SMART'),
('a6ee15a1-3d59-40ba-a5a0-541d94efc731', 'Bangunan Jaya', 'SMART'),
('39d8cdb5-668f-414a-b79a-8f28eb5df802', 'Bank Nobu Linggau', 'SMART'),
('4becc0f6-1145-480e-8ad4-ecd59419ec35', 'BCA Baturaja', 'SMART'),
('0ae24187-d939-4c4e-bda5-10f24f5fd344', 'BCA Belitang', 'SMART'),
('1c44ab6b-870e-4e69-8bf5-fd34d39577fd', 'BCA Demang', 'SMART'),
('273c4a9a-700f-4378-8b41-bb7b19784974', 'BCA Lahat', 'SMART'),
('1438a569-cc07-4d17-a2bd-f28b912da076', 'BCA Martapura', 'SMART'),
('91eb1015-a5ab-444f-96a6-04c695af51c0', 'BCA Masjid Lama', 'SMART'),
('632f3d39-975c-448c-a202-ddf5b53af41f', 'BCA Muaraenim', 'SMART'),
('1250650b-d9f0-46c9-950a-8ae24a566c45', 'BCA Pagar Alam', 'SMART'),
('ada64422-9d43-4036-9970-84c8a0272096', 'BCA Prabumulih', 'SMART'),
('49edb531-dd5e-4ca8-8aa4-0ce80737ce2a', 'BCA Sekayu', 'SMART'),
('70550091-7e7c-4ee5-ad8a-d024d51b9a83', 'BCA Syariah', 'SMART'),
('1a9cf858-bfcb-48da-b9fe-0c204fd8df44', 'BCA Tanjung Enim', 'SMART'),
('e5a3cebc-df3d-493d-8b2c-5158caa8f7c0', 'BMM Kertapati', 'SMART'),
('51bb1ff8-32db-4be5-b9ea-bb4026cf3a80', 'BMM Perintis', 'SMART'),
('74c1e660-3304-4bd9-bbc3-80a672158a52', 'BMM Rjwali', 'SMART'),
('d38a6ae8-b594-4d9c-ba77-89ec3a58733c', 'BPSDMD Pemprov Sumsel', 'SMART'),
('e87368af-c864-4663-ad56-52fc7c5e3ff3', 'Cakra Indo', 'SMART'),
('e73b6b64-bcff-4317-b68a-c5a3ad5cb475', 'Central Internasional', 'SMART'),
('07e45f67-19b7-4332-af68-887335c02e90', 'Club', 'SMART'),
('1db7de61-55ff-4063-859f-34b2c4694556', 'CSS Tj Apiapi', 'SMART'),
('23fa030f-20e2-4b23-a805-871b040b9644', 'CV. Alfa Iceman', 'SMART'),
('0df6e1da-8123-4f72-aaee-8cd41a6f3cc7', 'CV. Sungai Intan', 'SMART'),
('68f2239b-240a-4eea-8101-08b96b149275', 'CV. Tedmond Fibre Glass', 'SMART'),
('98a3b64d-05e0-436f-bffe-a8c9fc36a1d1', 'CV. Tedmond Sutopo', 'SMART'),
('a69668ff-99e2-4978-b38c-7b92f791ccc9', 'Dapur Mutiara', 'SMART'),
('13cd1322-2f2b-47cb-bf96-22726d133afa', 'Deltapack Km 12', 'SMART'),
('208e3299-56dc-46f6-9462-a70e0a653a45', 'Doonlop', 'SMART'),
('8ac7c89a-14ba-4415-932f-a152b445379b', 'D''Vinci', 'SMART'),
('e96818df-d186-4419-b7d2-169ad3b3848b', 'Express In', 'SMART'),
('c202b3e4-e78f-4470-a02c-e53014006fe8', 'Fabel Kost', 'SMART'),
('8837171e-2900-44a4-ba4d-4a4924ae93e8', 'Gereja', 'SMART'),
('87426b52-0e3d-46eb-8fb8-a926e5c07e01', 'Graha Maju Motor', 'SMART'),
('0dbeeae1-4647-4f7f-9a18-eb998fad8b2b', 'Gudang Hokkan Deltapack ', 'SMART'),
('3389ea02-db47-4eaf-8ef7-1e4d4ccaaabc', 'Hino Tj Api2', 'SMART'),
('de6aae5f-5211-43dd-8320-8e5380f952d8', 'HMM Km 7', 'SMART'),
('24ec9c73-f90e-4d5c-996b-3aefd14c9d07', 'HMM Tjapi', 'SMART'),
('66d9e29d-798f-4718-aa39-f654392a2145', 'Hokkan Deltapack Km 17', 'SMART'),
('05e75bd6-d12c-4b50-a698-b223fbcbe757', 'Hotel Anugrah', 'SMART'),
('331a9a86-487e-421f-863b-fde8711d9964', 'Hotel Ibis', 'SMART'),
('8a94706d-2b2a-4ce4-ae6f-28d948d83c0a', 'IGM', 'SMART'),
('c4e0499b-a2a3-4f38-8029-dcde24ab6431', 'Kediaman Rmh Bpk Chai Po', 'SMART'),
('cd20dabf-5c16-4456-86cb-f10486d91036', 'Kenten City', 'SMART'),
('6163e6f1-d1ad-47cb-8557-8b02bc770461', 'Kenten City Palembang', 'SMART'),
('937e7c09-a17d-4922-9607-8eb2da936c04', 'Kesuma Regency', 'SMART'),
('85b40440-932a-4184-8687-718954799677', 'KSO Pertamina EP ETT', 'SMART'),
('8ecae192-f4d5-4ec8-8f9b-66b0413d0d41', 'Kuala Permai', 'SMART'),
('fad7aad0-6c0d-438e-b229-ef9ef0393404', 'MBC HMM Tjapi', 'SMART'),
('6eb81f1d-a05e-4129-8640-18ee968da6e3', 'Pagas Narita', 'SMART'),
('8962600a-6416-4032-94f7-9a9aac63322d', 'Palembang Indah Mall (Le Garden)', 'SMART'),
('9a58d787-0331-4d67-beeb-94b844c7af94', 'Palembang Indah Mall (Admin)', 'SMART'),
('8ccdc84e-0f52-434e-9132-4d3f820b6975', 'Palembang Indah Mall (Ass Chieff)', 'SMART'),
('5443dcfb-5a91-495c-b67d-cb7738554bcf', 'Palembang Indah Mall (Chieff)', 'SMART'),
('fbfc957a-17ab-4993-97fc-2e42070eec0c', 'Palembang Indah Mall (Middle)', 'SMART'),
('d847c72d-f80f-4d9e-8420-fd58d615663d', 'Palembang Indah Mall (Regu A)', 'SMART'),
('30788798-529a-41c2-aa28-5ea8d5fb4427', 'Palembang Indah Mall (Regu B)', 'SMART'),
('fa39fa51-48d1-4906-8921-d4f91ace77b3', 'Palembang Indah Mall (Regu C)', 'SMART'),
('ee8e9115-8580-408d-8cb4-214f4eb1f6af', 'Parahita Diagnostic Center', 'SMART'),
('b62c52b1-580e-4740-9e67-e1dd184b5d85', 'Pempek Beringin Dempo', 'SMART'),
('9031179b-d0c0-4627-9567-74a0941a4b27', 'Piket Kantor', 'SMART'),
('c5c0ae16-3ff2-4168-a700-3947fc7979ea', 'PLG Regency', 'SMART'),
('929e42f6-9d96-461a-b807-8ae84122b87a', 'Politeknik Parawisata Jakabaring', 'SMART'),
('4d7b31ff-952e-49e0-bbc3-2408bc3587e3', 'Poll BCA Finance', 'SMART'),
('4c007451-ba1b-45b8-8230-411524e8c98f', 'PPI', 'SMART'),
('25f9dfa7-8568-457a-9032-312d354d08a8', 'Propan Raya', 'SMART'),
('46496410-71f4-4ad8-8749-17418b1c670e', 'PT. Perum Jam Krindo', 'SMART'),
('fb916655-81a0-4417-ad02-e5caf9a2c8a8', 'PT. Waskita Zona 3', 'SMART'),
('9849eec2-d7ce-4056-8f88-6771883b73c6', 'PT. Berkat Makmur Kontainer', 'SMART'),
('6d0310ed-faf3-48d1-abdd-de8b34125ff5', 'PT. BPR Berkat Sejati', 'SMART'),
('6dfa2a77-e33c-44ff-b5f4-fddde55ff0ec', 'PT. BPR Puskopat', 'SMART'),
('f7a4c61d-31c2-4a95-89d1-fe74b77e2036', 'PT. Cipta Mandala Lumber Nusantara', 'SMART'),
('032b9d29-f4df-4298-b3e3-180145e17deb', 'PT. Citra Thamrin Motor Jambi', 'SMART'),
('415f2add-36d2-4484-b5f7-64feaa154a75', 'PT. Duta Cab Pasar 16', 'SMART'),
('3a0cd33e-f3b0-41c6-af0f-4ee04ba1258f', 'PT. Duta Mulia Palembang', 'SMART'),
('f3343a1a-1849-48e6-b779-ad904f461c4f', 'PT. Duta Permata Lestari', 'SMART'),
('ec706b4c-5f11-49a8-9ea5-c1b24a47e634', 'PT. Indotirta Sriwijaya', 'SMART'),
('761aba45-9ccb-4ad5-971c-1ad58b84b0f5', 'PT. LBES', 'SMART'),
('4f4e76f9-79c0-45f7-92c7-b949f959a542', 'PT. Lumbung Pangan Banyuasin', 'SMART'),
('c88edc8a-e6ae-46bb-9c54-050c6efe0d0e', 'PT. Pembangunan Kalidoni', 'SMART'),
('8a7518b7-5208-4bfc-86a2-858cd127baec', 'PT. POS Ind Regional 3', 'SMART'),
('d1bad530-2b77-49ef-a0b7-62e4ab03f977', 'PT. Putra Sejahtera Sukses Mandiri', 'SMART'),
('42eb1a5b-418a-4370-914c-59b92e07906f', 'PT. Seino Indomobil Logistik', 'SMART'),
('fd7d1f9c-0b3c-4880-9aee-b83d2e25ebb4', 'PT. Sele Raya Belida ', 'SMART'),
('9d57a3fd-7ee8-4850-9e1c-9df7feed1ca5', 'PT. Sinar Niaga Sejahtera', 'SMART'),
('79b811aa-8fe3-4f09-9767-eab4961bad37', 'PT. Sumber Musi Sejahtera', 'SMART'),
('d04e49a3-45d7-4a9b-b7cc-e661275bcb69', 'PT. Surya Madistrindo Indralaya', 'SMART'),
('188583ea-146e-4595-9490-5b981c5a401f', 'PT. Surya Madistrindo Plg', 'SMART'),
('7f0f8143-9cce-4b4d-a637-9d6bb24d30ae', 'PT. Taman Bukit Mas', 'SMART'),
('fd3c6acd-5df7-47ac-bc91-3f68a728a226', 'PT. Waskita Jambi', 'SMART'),
('0dc48ec9-958f-4015-929c-de4989871b4a', 'PT. Waskita Karya', 'SMART'),
('4c5b030f-1e8f-4756-9712-8a5d0b7d9c0c', 'PT. Waskita Zona 3 ', 'SMART'),
('06b0dee9-0f5f-49cc-8b2e-999cc662fdb6', 'PT. Waskita Beton Soekarno', 'SMART'),
('2207aa42-7087-4d4f-9931-5c190f0bc5ae', 'PT. Waskita Yudo ', 'SMART'),
('8bdadc22-8df5-4881-b98d-358ec3c1d546', 'PT. Waskita Yudo Kantor', 'SMART'),
('fe7bad2e-58df-4d67-b962-e99f4b81b6e0', 'PTPN VII Bentayan', 'SMART'),
('03b8d78f-7850-4f2c-97aa-924db174019e', 'PTPN VII Beringin', 'SMART'),
('dfe04ff2-1f73-4dae-9468-7b7c9a13ad67', 'PTPN VII Betung', 'SMART'),
('f2240515-fcd4-4370-87b6-e4c53a865f6f', 'PTPN VII Bom Baru', 'SMART'),
('b003fe9f-4639-4c90-b4e6-e4f1a88d4195', 'PTPN VII Ketahun', 'SMART'),
('6e58f86e-7e67-4c93-8459-5457e2493b4c', 'PTPN VII Km 9', 'SMART'),
('af12f768-a978-4b0e-8eba-dd2c3a10bf5a', 'PTPN VII Musi Landas', 'SMART'),
('97f890ca-2aa2-442a-98fb-a2f23965b85b', 'PTPN VII Padang Pelawi', 'SMART'),
('51d52edf-1ee0-4d79-b358-780a6ab9235c', 'PTPN VII Pagar Alam', 'SMART'),
('f53d9cbb-008f-4de8-aba9-9a7fa199835b', 'PTPN VII Suli', 'SMART'),
('0bbdc6be-7f2e-486c-9aa2-b04cd259d250', 'PTPN VII Sungai Niru', 'SMART'),
('623570c9-1d92-4907-9785-262af3f57ea6', 'PTPN VII Talang Sawit', 'SMART'),
('dc6f6b15-7bd0-4a68-a870-be1ff3ebaf78', 'PTPN VII Talo Pino', 'SMART'),
('9b295e9a-5e7e-4127-b61b-a28459e094ef', 'PTPN VII Tebenan', 'SMART'),
('68d6f7c0-c4f1-408f-bc16-d1e63c2764ee', 'Resto Ayam Jerit', 'SMART'),
('8d0e7d1a-00d2-4444-a946-e661e4af400a', 'Resto Bukit Golf Dan Kopitiam', 'SMART'),
('f5a1f674-c9e4-4873-956e-619774259a85', 'Resto Gardenta & Cofee Newton', 'SMART'),
('dc8a3364-5823-4087-8db8-df951feafc36', 'Resto Richeese Factory', 'SMART'),
('39d23e4a-ccaa-40c0-b176-4c0f6679141d', 'Resto Richeese Factory Kampus', 'SMART'),
('752825c1-e610-4ded-83c2-8d23e0e65606', 'RS Charitas', 'SMART'),
('3ba93b07-bd90-46a7-8922-ee6bc25252f3', 'Ruko Cakra', 'SMART'),
('977e678d-b839-4ee1-9263-cffc53bf7944', 'Rumah Bpk Setiawan', 'SMART'),
('c3bed946-33b8-4f78-afb9-10c858b8451c', 'Rumah Ibu Lani', 'SMART'),
('4a1e6d77-60b3-4e74-bd8f-a76b8f3ffc7f', 'Rumah Pak Roy', 'SMART'),
('74dae733-effc-49c5-b615-0a5042b840aa', 'Sapta Indah', 'SMART'),
('3c835230-55dd-4b0c-b1e6-89e1a6f6d8cd', 'Selebrity', 'SMART'),
('d5756d54-e61b-4eac-bbe9-caa68906d31d', 'Showroom Hino', 'SMART'),
('0a9f18d8-2bcf-4a44-8ba3-f3f2c648e132', 'Sinar Niaga Sejahtera', 'SMART'),
('9ef77d6f-7c17-4db7-9f8f-a8c3cb9e488d', 'Sinar Niaga Sejahtera Prabumulih', 'SMART'),
('1224c4a9-f1d0-45f7-9521-a3f417a91d18', 'Social Market (SOMA)', 'SMART'),
('8308192f-5ef6-4868-9974-319340027d0f', 'SPBU Jakabaring', 'SMART'),
('d57be265-b2e7-42ba-9306-7817e80dcd3b', 'Sriwalk Kedamaian', 'SMART'),
('15cc96d6-b679-4c13-89e2-c003c66cba3a', 'Sumsel Media Grafika', 'SMART'),
('383cb248-69e3-4ed1-a45e-438e3b5c45d2', 'Sutopo Lestari Jaya', 'SMART'),
('8c720193-4e38-4fd7-877b-c78762046fac', 'Taciro Gradball Room', 'SMART'),
